package com.wjp.wdada.service.impl;
...
import com.wjp.wdada.constant.CommonConstant;
import com.wjp.wdada.exception.ThrowUtils;
import com.wjp.wdada.mapper.AppMapper;
import com.wjp.wdada.model.dto.app.AppQueryRequest;
...
import com.wjp.wdada.model.enums.ReviewStatusEnum;
import com.wjp.wdada.model.vo.AppVO;
import com.wjp.wdada.model.vo.UserVO;
import com.wjp.wdada.service.AppService;
import com.wjp.wdada.service.UserService;
import com.wjp.wdada.utils.SqlUtils;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            AppTypeEnum appTypeStatusEnum = AppTypeEnum.getEnumByValue(appType);
            ThrowUtils.throwIf(appTypeStatusEnum == null, ErrorCode.PARAMS_ERROR, "应用类型非法");

            AppScoringStrategyEnum scoringStrategyStatusEnum = AppScoringStrategyEnum.getEnumByValue(scoringStrategy);
            ThrowUtils.throwIf(scoringStrategyStatusEnum == null, ErrorCode.PARAMS_ERROR, "评分策略非法");
        }
        // 修改数据时，有参数则校验
        // 补充校验规则
