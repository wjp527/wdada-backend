...
import com.wjp.wdada.mapper.ScoringResultMapper;
import com.wjp.wdada.model.dto.scoringResult.ScoringResultQueryRequest;
...
import com.wjp.wdada.model.vo.ScoringResultVO;
...
public class ScoringResultServiceImpl extends ServiceImpl<ScoringResultMapper, ScoringResult> implements ScoringResultService {
    ...
    public void validScoringResult(ScoringResult scoringResult, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(resultScoreRange == null || (resultScoreRange <= 0 || resultScoreRange > 100), ErrorCode.PARAMS_ERROR, "结果分值范围不能为空");
        }
        // 修改数据时，有参数则校验
        // 补充校验规则
