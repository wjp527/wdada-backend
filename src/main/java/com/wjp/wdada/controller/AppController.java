...
import com.wjp.wdada.model.dto.app.AppAddRequest;
import com.wjp.wdada.model.dto.app.AppEditRequest;
import com.wjp.wdada.model.dto.app.AppQueryRequest;
import com.wjp.wdada.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    @PostMapping("/review")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> doAppReview(@RequestBody ReviewRequest reviewRequest, HttpServletRequest httpServletRequest) {
        ...
        App oldApp = appService.getById(id);
        ThrowUtils.throwIf(oldApp == null, ErrorCode.NOT_FOUND_ERROR);
        // 如果要更改的状态与数据库一致，则抛出异常
        Integer oldAppReviewStatus = oldApp.getReviewStatus();
        ThrowUtils.throwIf(oldAppReviewStatus.equals(reviewStatus), ErrorCode.OPERATION_ERROR, "请勿重复提交");
